...
EXTERN_C const IID IID_IVP8PostProcessing;
    ...
    typedef struct IVP8PostProcessingVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IVP8PostProcessing, SetFlags)
        HRESULT ( STDMETHODCALLTYPE *SetFlags )( 
            IVP8PostProcessing * This,
            /* [in] */ int PostProcessingFlags);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, GetFlags)
        HRESULT ( STDMETHODCALLTYPE *GetFlags )( 
            IVP8PostProcessing * This,
            /* [out] */ int *pPostProcessingFlags);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, SetDeblockingLevel)
        HRESULT ( STDMETHODCALLTYPE *SetDeblockingLevel )( 
            IVP8PostProcessing * This,
            /* [in] */ int DeblockingLevel);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, GetDeblockingLevel)
        HRESULT ( STDMETHODCALLTYPE *GetDeblockingLevel )( 
            IVP8PostProcessing * This,
            /* [out] */ int *pDeblockingLevel);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, SetNoiseLevel)
        HRESULT ( STDMETHODCALLTYPE *SetNoiseLevel )( 
            IVP8PostProcessing * This,
            /* [in] */ int NoiseLevel);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, GetNoiseLevel)
        HRESULT ( STDMETHODCALLTYPE *GetNoiseLevel )( 
            IVP8PostProcessing * This,
            /* [out] */ int *pNoiseLevel);
        
        DECLSPEC_XFGVIRT(IVP8PostProcessing, ApplyPostProcessing)
